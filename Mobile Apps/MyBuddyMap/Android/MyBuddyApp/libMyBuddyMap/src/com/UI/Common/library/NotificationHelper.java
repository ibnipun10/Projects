...
public class NotificationHelper {
	...
	public void createNotification() {
		...
		mNotificationBuilder.setTicker(Constants.NOTIFICATION_FB_ANALYSE);
		mNotificationBuilder.setContentTitle(Constants.NOTIFICATION_FB_ANALYSE);
		...
		mNotificationBuilder.setContentText(Constants.NOTIFICATION_FB_ANALYSE);
	...
	public void progressUpdate(String message) {
		...
		mNotificationBuilder.setTicker(message);
		mNotification = mNotificationBuilder.build();
