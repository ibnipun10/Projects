...
public class NotificationHelper {
    ...
    public void createNotification() {
        ...
        mNotificationBuilder.setTicker(Constants.STATUS_BAR_PHYSIOIT_UPDATE);
        mNotificationBuilder.setContentTitle(Constants.STATUS_BAR_PHYSIOIT_UPDATE);
        ...
        mNotificationBuilder.setContentText(Constants.STATUS_BAR_UPDATE_DESCRIPTION);
