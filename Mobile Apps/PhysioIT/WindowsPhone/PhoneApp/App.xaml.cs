...
namespace PhoneApp
{
    public partial class App : Application
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient(
                "https://physioitsservice.azure-mobile.net/",
                "qUtgocMuHJkYLvOhXwFUQhuhSOimKf69" );
       ...
       //     AsyncSynchronizationContext.Register();
        ...
        static void TaskScheduler_UnobservedTaskException(object sender, UnobservedTaskExceptionEventArgs e)
        {
             ...
             */
            CrashLog.WriteCrashLog(e.Exception);
        }
        ...
        {
            //This is for facebook webExceptionWrapper
            if (e.ExceptionObject is Facebook.WebExceptionWrapper)
            {
                e.Handled = true;
                return;
            }
            ...
            CrashLog.WriteCrashLog(e.ExceptionObject);
        }
    ...
    public class AsyncSynchronizationContext : SynchronizationContext
    {
        ...
        private static SendOrPostCallback WrapCallback(SendOrPostCallback sendOrPostCallback)
        {
            return state =>
            {
                ...
                if (exception != null)
                {
                    CrashLog.WriteCrashLog(exception);
